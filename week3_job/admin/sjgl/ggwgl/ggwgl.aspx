<%@ page language="C#" autoeventwireup="true" inherits="admin_sjgl_ggwgl_ggwgl, App_Web_ggwgl.aspx.8505cb0b" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
    ...
    //需要用模式对话框，需要检查是否登陆，需要根据值刷新本页
            ...
            o.item = '';
            o.title = "添加广告位";
            o.url = '../admin/sjgl/ggwgl/add.aspx';
    ...
    function xiugai(obj)
    {
        ...
        o.item = '';
        o.title = "修改广告位";
        o.url = '../admin/sjgl/ggwgl/Modify.aspx?id='+value;
        var retval = window.showModalDialog("../../../html/modaldialog.htm", o, "dialogWidth:"+width+"px; dialogHeight:"+height+"px; help:no");
        if (retval == "ok") {
            window.location.href=window.location.href;
        }
