<%@ page language="C#" autoeventwireup="true" inherits="admin_sjgl_qzzgl_qzzgl, App_Web_qzzgl.aspx.f0315bc2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                            ...
                                            <table class="tbChaxun" cellpadding=0 cellspacing=0 border=0 style="width:100%;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <b>所属行业</b></td>
                                                    <td>
                                                        <asp:DropDownList ID="ctlqw_guozuohy" runat="server" Width="140px">
                                                        </asp:DropDownList></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td style="height: 16px">
                                                        <asp:DropDownList ID="ctlxingbie" runat="server" Width="140px" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><asp:DropDownList ID="ctlgongzuonx" runat="server" Width="140px" >
                                                        <asp:ListItem  Value="">不限</asp:ListItem>
                                              ...
                                              <tr>
                                                    ...
                                                    <td>   <asp:DropDownList ID="ctlxueli" runat="server" Width="140px" >
                                                            <asp:ListItem  Value="">不限</asp:ListItem>
                                    ...
                                    <div class="xinwenlanDiv" style="width:97%;">
                                        ...
                                        <asp:GridView ID="grdview" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="qw_guozuohy" HeaderText="所属行业" />
