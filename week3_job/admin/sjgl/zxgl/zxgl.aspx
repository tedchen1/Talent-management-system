<%@ page language="C#" autoeventwireup="true" inherits="admin_sjgl_zxgl_zxgl, App_Web_zxgl.aspx.4b3a7283" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                            ...
                                            <table class="tbChaxun" cellpadding=0 cellspacing=0 border=0 style="width:100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="height: 16px">
                                                        <asp:TextBox ID="ctlstartdate" runat="server" Width="111px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td style="width:51px;">
                                                        <b>时间&lt;</b></td>
                                                    <td>
                                                        <asp:TextBox ID="ctlEnddate" runat="server" Width="111px"></asp:TextBox></td>
                                                </tr>
                                        ...
                                        <div class="xinwenlanDiv" style="width:590px;">
                                            ...
                                            AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="name" HeaderText="资讯标题" >
...
<script>
    ...
    //需要用模式对话框，需要检查是否登陆，需要根据值刷新本页
            ...
            o.item = '';
            o.title = "添加行业";
            o.url = '../admin/xtsz/hysz/add.aspx';
    ...
    function xiugai(obj)
    {
        ...
        o.item = '';
        o.title = "修改行业";
        o.url = '../admin/xtsz/hysz/Modify.aspx?id='+value;
        var retval = window.showModalDialog("../../../html/modaldialog.htm", o, "dialogWidth:"+width+"px; dialogHeight:"+height+"px; help:no");
        if (retval == "ok") {
            window.location.href=window.location.href;
        }
