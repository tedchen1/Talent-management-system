<%@ page language="C#" autoeventwireup="true" inherits="admin_sjgl_zxlx_zxlx, App_Web_zxlx.aspx.1afd728f" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                        ...
                                        <div class="xinwenlanDiv" style="width:590px;">
                                            ...
                                            AutoGenerateColumns="False" BackColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="name" HeaderText="资讯类型名称" >
...
<script>
    ...
    //需要用模式对话框，需要检查是否登陆，需要根据值刷新本页
            ...
            o.item = '';
            o.title = "添加资讯类型";
            o.url = '../admin/sjgl/zxlx/add.aspx';
    ...
    function xiugai(obj)
    {
        ...
        o.item = '';
        o.title = "修改咨询类型";
        o.url = '../admin/sjgl/zxlx/Modify.aspx?id='+value;
        var retval = window.showModalDialog("../../../html/modaldialog.htm", o, "dialogWidth:"+width+"px; dialogHeight:"+height+"px; help:no");
        if (retval == "ok") {
            window.location.href=window.location.href;
        }
