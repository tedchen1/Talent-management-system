<%@ page language="C#" autoeventwireup="true" inherits="admin_xtgl_glygl, App_Web_glygl.aspx.7c61da71" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                    ...
                                    <div class="xinwenlanDiv" style="width:97%;">
                                        ...
                                        <asp:GridView ID="grdview" runat="server" AutoGenerateColumns="False" BackColor="White"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ip" HeaderText="注册ip" />
                                                <asp:BoundField DataField="fabu_date" HeaderText="注册时间" />
                                              <%--    <asp:TemplateField>
                                                    <ItemTemplate>
...
<script>
    ...
    //需要用模式对话框，需要检查是否登陆，需要根据值刷新本页
            ...
            o.item = '';
            o.title = "添加管理员";
            o.url = '../admin/xtgl/glygl/add.aspx';
