<%@ page language="C#" autoeventwireup="true" inherits="admin_xtsz_flgl_add, App_Web_add.aspx.ebb64bb2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <FIELDSET>
       ...
       <table cellSpacing="0" cellPadding="0" width="100%" border="0">
	        ...
	        <td height="25" width="*" align="left">
                ...
                <br />
                <span style="color:Red;">建议图片大小：770×220，类型：jpg &nbsp; &nbsp; &nbsp; &nbsp;如需上传，请先在下面上传图片！</span> </td></tr>
	        <tr>
	        <td height="25" width="30%" align="right">
		        跳转到哪个页面
	        </td>
