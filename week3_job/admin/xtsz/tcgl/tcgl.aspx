<%@ page language="C#" autoeventwireup="true" inherits="admin_xtsz_tcgl_tcgl, App_Web_tcgl.aspx.30053791" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                ...
                                <tr valign=top>
                                    ...
                                    <td id="tdleft2" class="neirongkuang" >
                                        ...
                                        <div class="neirongkuang_lan2 a13_redian duanluo">
                                            套餐是指招聘单位的权限套餐，套餐里设定了可以发布职位的数量，可查询个人简历的期限，可发站内消息的数量!
                                        </div>
                                        <br />
...
<script>
    ...
    //需要用模式对话框，需要检查是否登陆，需要根据值刷新本页
            ...
            o.item = '';
            o.title = "添加套餐";
            o.url = '../admin/xtsz/tcgl/add.aspx';
    ...
    function xiugai(obj)
    {
        ...
        o.item = '';
        o.title = "修改套餐";
        o.url = '../admin/xtsz/tcgl/Modify.aspx?id='+value;
        var retval = window.showModalDialog("../../../html/modaldialog.htm", o, "dialogWidth:"+width+"px; dialogHeight:"+height+"px; help:no");
        if (retval == "ok") {
            window.location.href=window.location.href;
        }
