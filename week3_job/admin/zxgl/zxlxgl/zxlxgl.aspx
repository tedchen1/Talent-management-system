<%@ page language="C#" autoeventwireup="true" inherits="admin_zxgl_zxlxgl_zxlxgl, App_Web_zxlxgl.aspx.dc6075b4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
    ...
    //需要用模式对话框，需要检查是否登陆，需要根据值刷新本页
            ...
            o.item = '';
            o.title = "添加资讯类型";
            o.url = '../admin/zxgl/zxlxgl/add.aspx';
    ...
    function xiugai(obj)
    {
        ...
        o.item = '';
        o.title = "修改资讯类型";
        o.url = '../admin/zxgl/zxlxgl/Modify.aspx?id='+value;
        var retval = window.showModalDialog("../../../html/modaldialog.htm", o, "dialogWidth:"+width+"px; dialogHeight:"+height+"px; help:no");
        if (retval == "ok") {
            window.location.href=window.location.href;
        }
