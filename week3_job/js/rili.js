...
///初始化日期
function initDate(objid,day)
{
    var b = new Date();
    var c = new Date(b.getFullYear(),b.getMonth(),b.getDate()+day);
    
    document.getElementById(objid).setAttribute("value",c.getFullYear()+"-"+(c.getMonth()+1)+"-"+c.getDate());
}