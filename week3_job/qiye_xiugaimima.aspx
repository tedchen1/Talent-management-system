<%@ page language="C#" autoeventwireup="true" inherits="qiye_xiugaimima, App_Web_qiye_xiugaimima.aspx.cdcab7d2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                    ...
                                    <td valign=top>
                                        ...
                                        <div class="xinwenlanDiv" style="margin-top: 8px; left: 40px; width: 600px; position: relative;
                                            ...
                                            <div class="xinwenlanDiv_top_tou3">
                                                <a class="kuangBiaoti" href="youqinglianjie.aspx">修改密码 </a>
                                            </div>
                                            <!--修改这里：添加新闻-->
                                                    ...
                                                    <table id="jianliTb" border="0" cellpadding="3" cellspacing="0" style="width: 100%">
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td style="height: 19px">
                                                                <asp:TextBox ID="txtpwd2" runat="server" CssClass="date" Height="14px" MaxLength="25"
                                                        ...
                                                        <tr valign="top">
                                                            ...
                                                            <td style="padding-bottom: 2px; padding-top: 8px">
                                                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="修改密码" /></td>
                                                        </tr>
                                                    </table>
                                                </li>
                                            </ul>
