<%@ page language="C#" autoeventwireup="true" inherits="user_index, App_Web_user_index.aspx.cdcab7d2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                ...
                                <tr valign=top>
                                    ...
                                    <div style="margin-top:30px;width:88%;padding:10px;position:relative;left:40px; top: 0px;" class="lvkuangDiv">
                                        ...
                                        <div style="margin-top:5px;margin-bottom:5px;">
                                            &nbsp;<asp:Button ID="btnshuaxin" runat="server" Text="刷新简历" OnClick="btnshuaxin_Click" />&nbsp; 
                                            <a href="createhtml/rencai_<%=getUserid()%>.htm" target=_blank>【查看我的简历】 </a>
                                            <a href="user_jianli.aspx">【修改我的简历】 </a>
                                           <a href="#">&nbsp;</a>
                                        </div>
                                      
                                        <div style="color:Red;">
                                            提示：刷新简历可以使您的简历提前；</div>
                                    </div>
                                        <br />
                                        <br />
                                        <br />
                                        <div class="xinwenlanDiv" style="margin-top: 8px; left: 40px; width: 673px; ">
                                            <div class="xinwenlanDiv_top_tou3" style="left: 15px; width: 126px; top: -7px;z-index:100;">
